...
import {sUSDeCooldownRequestImpl as SUSDeCooldownRequestImpl} from
    "../contracts/tranches/strategies/ethena/sUSDeCooldownRequestImpl.sol";
import {
    sUSDeAprPairProvider as SUSDeAprPairProvider,
    IsUSDS
} from "../contracts/tranches/strategies/ethena/sUSDeAprPairProvider.sol";
...
contract CDOTest is Test {
    ...
    function setUp() public {
        ...
        address[] memory unstakeAddrs = new address[](1);
        unstakeAddrs[0] = address(sUSDe);
        IUnstakeHandler[] memory unstakeImpls = new IUnstakeHandler[](1);
        unstakeImpls[0] = IUnstakeHandler(address(sUSDeCooldownRequestImpl));
